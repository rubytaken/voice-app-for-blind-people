                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <button
                      ...
                      className="flex-shrink-0 p-2 text-stone-400 hover:text-red-500 dark:hover:text-red-400 opacity-0 group-hover:opacity-100 transition-all rounded-lg hover:bg-stone-100 dark:hover:bg-stone-700"
